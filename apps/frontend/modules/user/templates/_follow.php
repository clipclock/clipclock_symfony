<div class="b-btn">
	<?php if($active != 'my'): ?>
    <?php echo link_to($state_names[0], array('sf_route' => $sf_routes[0], $id_key => $id), array('class' => sprintf('ajax-button default-'.(isset($board_view) && $board_view ? 'un-' : '').'follow-btn %s', ($active) ? 'hidden' : ''))); ?>
