...
$.fn.wookmark = function(options) {
	...
	if(options == 'update') {
		this.wookmarkOptions = $(this).data('wookmark').options;
		this.wookmarkColumns = $(this).data('wookmark').columns;
		this.wookmarkContainerWidth = $(this).data('wookmark').containersWidth;
	}
	else
	{
	...
	$(this).data('wookmark', {
		target : $(this),
		columns: this.wookmarkColumns,
		containersWidth: this.wookmarkContainerWidth,
		options: this.wookmarkOptions
	});
