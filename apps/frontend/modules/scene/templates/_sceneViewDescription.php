<div class="inside">
	...
	<p>
		<span class="t-bl"><a href="<?php echo url_for('user', $scene->getSfGuardUserProfile())?>"><?php echo $scene->getSfGuardUserProfile()?></a>, Clipped 2 hours ago from <strong>YouTube</strong></span>
