	...
	<?php include_component('user', 'navigationPerson', array('subject' => $user, 'active' => 'boards', 'current_user' => $current_user, 'user' => $user,
...
<div class="content-wrap-in">
	...
	<div class="long-col">
		...
		<script type="text/javascript">
			layoutAndScroll('<?php echo url_for('my_boards_page', array('nick' => $user->getNick(), 'page' => $pager->getNextPage())) ?>', 'board_sticker');
		</script>
	</div>
</div>
