...
abstract class BaseTokenPeer {
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'TOKEN_KEY', 'TOKEN_SECRET', 'USER_ID', 'EXPIRE', 'PARAMS', 'IDENTIFIER', 'STATUS', 'O_AUTH_VERSION', 'CREATED_AT', 'UPDATED_AT', ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'TOKEN_KEY' => 2, 'TOKEN_SECRET' => 3, 'USER_ID' => 4, 'EXPIRE' => 5, 'PARAMS' => 6, 'IDENTIFIER' => 7, 'STATUS' => 8, 'O_AUTH_VERSION' => 9, 'CREATED_AT' => 10, 'UPDATED_AT' => 11, ),
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn($alias . '.TOKEN_KEY');
			$criteria->addSelectColumn($alias . '.TOKEN_SECRET');
			...
			$criteria->addSelectColumn($alias . '.O_AUTH_VERSION');
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(TokenPeer::ID);
			if ($value) {
				$selectCriteria->add(TokenPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(TokenPeer::TABLE_NAME);
			}

			$comparison = $criteria->getComparison(TokenPeer::USER_ID);
			$value = $criteria->remove(TokenPeer::USER_ID);
			if ($value) {
				$selectCriteria->add(TokenPeer::USER_ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(TokenPeer::TABLE_NAME);
			}
	...
	public static function retrieveByPK($id, $user_id, PropelPDO $con = null) {
		$_instancePoolKey = serialize(array((string) $id, (string) $user_id));
 		if (null !== ($obj = TokenPeer::getInstanceFromPool($_instancePoolKey))) {
 			return $obj;
		}
