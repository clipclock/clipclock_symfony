	...
	<li class="active">
		<div class="b-comment">
			<div class="inside">
				...
				<p><a href="<?php echo url_for('user', array('nick' => $scene_info['nick']))?>"><?php echo $scene_info['first_name'];?></a><br /><?php echo truncate_text($scene_info['text'], 140, '…', true);?></p>
			</div>
		</div>
	<?php foreach($comments as $key => $comment):?>
		<div class="b-comment">
			<div class="inside">
				...
				<p><a href="<?php echo url_for('user', $comment->getSfGuardUserProfile())?>"><?php echo $comment->getSfGuardUserProfile()->getFirstName()?></a><br /><?php echo truncate_text($comment->getText(), 140, '…', true)?></p>
			</div>
		</div>
	<?php endforeach;?>
	</li>
