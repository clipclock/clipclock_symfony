	...
	<li class="active">
		<div class="b-comment">
			<div class="inside">
				...
				<p><a href="<?php echo url_for('user', array('nick' => $scene_info['nick']))?>"><?php echo $scene_info['nick'];?></a><br /><?php echo $scene_info['text'];?></p>
			</div>
		</div>
	<?php foreach($comments as $key => $comment):?>
		<div class="b-comment">
			<div class="inside">
				...
				<p><a href="<?php echo url_for('user', $comment->getSfGuardUserProfile())?>"><?php echo $comment->getSfGuardUserProfile()?></a><br /><?php echo $comment->getText()?></p>
			</div>
		</div>
	<?php endforeach;?>
	</li>
