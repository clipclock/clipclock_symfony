...
<?php echo $pager->getNextPage().' '.$current_board->getId().' '.$current_user->getNick() ?>
<?php echo url_for('board_page', array('id' => $current_board->getId(), 'username_slug' => $current_user->getNick(), 'page' => $pager->getNextPage())) ?>"><?php echo $pager->getNext();?>
